...
function setup() {
  ...
  // Optionally set a font that supports emojis (if available on your system)
  textFont("Arial");
...
class Missile {
  ...
  display() {
    push();
      ...
      // Ensure the emoji is visible by setting fill and increasing text size
      fill(255);
...
// Displays as a warship emoji with animated fire
// ------------------------------------------------------
class RocketStructure {
  ...
  display() {
    push();
      translate(this.pos.x, this.pos.y, this.pos.z);
      textAlign(CENTER, CENTER);
      // Draw warship emoji with animated fire
      fill(255);
      textSize(32);
      text("🚢", 0, 0);
